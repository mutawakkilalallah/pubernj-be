...
const { getAll, getByUuid, getImage, filterWilayah, filterBlok, dafatarRombongan, getByCard, getByNama } = require("./controller");
...
router.get("/cari", access.internal, getByNama);

router.get("/image/:niup", getImage);

router.get("/card/:card", access.internal, getByCard);
router.get("/:uuid", access.internal, getByUuid);
router.post("/daftar/:uuid", access.wilayah, lockdata.lockDropspot, dafatarRombongan);
